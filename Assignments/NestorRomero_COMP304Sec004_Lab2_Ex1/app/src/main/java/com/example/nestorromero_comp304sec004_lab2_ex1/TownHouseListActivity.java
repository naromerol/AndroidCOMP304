 ...
 *
 * List of townhouse units
 */
public class TownHouseListActivity extends ListActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_townhouse_list);

        //Retrieve data for view
        DataService dataService = DataService.getInstance();
        ArrayList<RealEstateUnit> unitList = dataService.getUnitsByType(RealEstateUnitType.TOWNHOUSE);
