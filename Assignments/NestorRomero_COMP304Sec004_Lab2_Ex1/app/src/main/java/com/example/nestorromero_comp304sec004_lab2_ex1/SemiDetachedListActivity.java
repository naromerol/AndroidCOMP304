 ...
 *
 * List of semi-detached units
 */
public class SemiDetachedListActivity extends ListActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_semidetached_list);

        //Retrieve data for view
        DataService dataService = DataService.getInstance();
        ArrayList<RealEstateUnit> unitList = dataService.getUnitsByType(RealEstateUnitType.SEMIDETACHED);
