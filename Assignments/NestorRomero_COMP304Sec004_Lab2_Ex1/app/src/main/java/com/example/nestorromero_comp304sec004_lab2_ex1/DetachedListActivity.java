 ...
 *
 * List of detached units
 */
public class DetachedListActivity extends ListActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_detached_list);

        //Retrieve data for view
        DataService dataService = DataService.getInstance();
        ArrayList<RealEstateUnit> unitList = dataService.getUnitsByType(RealEstateUnitType.DETACHED);
